...
In terms of modeling, rumor had it that the best results could be obtained by focusing on gradient boosting with the `xgboost` package and tuning the parameters while also doubling back to work on particularly weak precinicts based on the predictive results. 
